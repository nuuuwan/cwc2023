...
class AbstractUpdateData:
    @property
    def label(self):
        return camel_to_snake(self.__class__.__name__[6:])
    ...
    @cached_property
    def log(self):
        return Log(self.label)

    @property
    def js_path(self):
        return os.path.join(
            'src', 'nonview', 'data', f'{self.js_var_name}.js'
        )
    ...
    def driver(self):
        ...
        screenshot_path = os.path.join(f'screenshot.{self.label}.png')
    ...
    def header_lines(self) -> list[str]:
        ...
        return [
            f'// Auto Generated by {self.__class__.__name__}',
            f'// {self.url}',
            f'// {timestamp}',
            '',
        ]
